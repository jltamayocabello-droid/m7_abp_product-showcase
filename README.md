...
tanto los aspectos generales como los específicos, proporcionando al

Pág. 2

participante una guía clara de las expectativas técnicas y funcionales del
proyecto.
Paso a paso 👣
Este proyecto refiere exclusivamente al módulo 7: DESARROLLO DE
APLICACIONES FRONT-END CON FRAMEWORK VUE, y se compone de 5 etapas
(lecciones), las cuales podrás avanzar de forma progresiva y escalonada con la
ayuda de los manuales teóricos y los contenidos desarrollados en las clases en
vivo.
